...
echo -e "\e[36m
┏╍┅┅┅╍⪻ Wybie ⪼┅┅┅┅┅┓
┋❥ 𝐂𝐫𝐞𝐚𝐝𝐨𝐫 : joelsantamariadelacruz
┋❥ 𝐘𝐨𝐮𝐭𝐮𝐛𝐞 : www.youtube.com
┋❥ 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 : www.facebook.com/joelsantamaria
┋❥ 𝐆𝐢𝐭𝐇𝐮𝐛 : github.com/Ruizrk/Js
┋❥ 𝐌𝐞𝐫𝐜𝐚𝐝𝐨 𝐩𝐚𝐠𝐨, 𝐚𝐥𝐢𝐚𝐬:🏦
┋┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅
...
echo -e "\033[01;32m\033[01mＩＮＩＣＩＡＮＤＯ 𝐖𝐘𝐁𝐈𝐄 𝐃' 𝐌 🚀\n\033[0m"
npm start
