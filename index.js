...
sock.sendMessage(fucker.from, { contacts: { displayName: '✨ 𝐖𝐘𝐁𝐈𝐄-𝐁𝐎𝐓 ✨', contacts: [{ vcard }] }}, {quoted: call, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
await sleep(8000)
...
newsletterJid: '120363296103096943@newsletter', 
serverMessageId: '', 
newsletterName: '✨ 𝐖𝐘𝐁𝐈𝐄-𝐁𝐎𝐓 ✨' }, forwardingScore: 9999999, isForwarded: true, mentionedJid:[num], "externalAdReply": { 
"title": `乂 ＷＥＬＣＯＭＥ 乂`, 
"body": `${name.split("@")[0]}`, 
"previewType": "PHOTO", 
"thumbnailUrl": null,
